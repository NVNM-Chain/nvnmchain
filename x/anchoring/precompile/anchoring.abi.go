...
var (
	...
	// registriesByName(string,uint8,(bytes,uint64,uint64,bool,bool))
	RegistriesByNameSelector = [4]byte{0x55, 0x22, 0xe6, 0xc6}
...
const RegistriesByNameCallStaticSize = 96
...
func (value RegistriesByNameCall) EncodeTo(buf []byte) (int, error) {
	...
	// Field MatchMode: uint8
	if _, err := abi.EncodeUint8(value.MatchMode, buf[32:]); err != nil {
		return 0, err
	}
...
func (t *RegistriesByNameCall) Decode(data []byte) (int, error) {
	...
	// Decode static field MatchMode: uint8
	t.MatchMode, _, err = abi.DecodeUint8(data[32:])
	if err != nil {
		return 0, err
	}
	// Decode dynamic field Pagination
