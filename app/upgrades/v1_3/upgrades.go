...
// (tranche 4 of the mainnet-full-export). Unset by default; only needed if an operator stages
// the export somewhere other than the default path under the node's home directory.
const exportDirEnvVar = "NVNMCHAIN_V1_3_EXPORT_DIR"
...
func CreateUpgradeHandler(
	...
	return func(c context.Context, plan upgradetypes.Plan, vm module.VersionMap) (module.VersionMap, error) {
		...
		ctx.Logger().Info("Starting v1.3.0 upgrade...")
		...
		exportDir := upgrades.ResolveExportDir(homeDir, "v1_3", exportDirEnvVar)
